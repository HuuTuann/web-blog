...
import { Form, Image, Input, Spinner, Textarea } from "@heroui/react";
...
const BusinessProfileForm = () => {
  ...
  return (
    <Form className="grid w-full grid-cols-3 gap-5" onSubmit={onSubmit}>
      ...
      {imageUrl ? (
        <div className="col-span-3 flex w-full flex-col items-stretch gap-1 rounded-lg">
          <div className="flex flex-1 items-center justify-between gap-2">
            <p className="text-sm font-medium text-gray-700">Image</p>
            <Button
              variant="ioBordered"
              onPress={() => {
                setValue(ManagementBusinessKeys.IMAGE, "");
              }}
            >
              Remove
            </Button>
